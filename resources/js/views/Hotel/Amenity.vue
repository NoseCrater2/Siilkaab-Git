        ...
        <div class="pa-4">
          <v-col cols="12" sm="6" md="12">
            <v-expansion-panels focusable accordion multiple>
              <v-expansion-panel>
                <v-expansion-panel-header>Informacion del edificio</v-expansion-panel-header>
                <v-expansion-panel-content style="margin-left: -13px">
                  <v-col cols="8" md="6">
                    <v-card outlined>
                      <v-row class="pa-6">
                        <span class="mb-4">
                        ...
                        <v-text-field v-model="amenities.num_rooms" required></v-text-field>
                      </v-row>
                    </v-card>
                  </v-col>
                  <v-col cols="8" md="6">
                    <v-card outlined>
                      <v-row class="pa-6">
                        ...
                        <v-text-field v-model="amenities.num_floors" required></v-text-field>
                      </v-row>
                    </v-card>
                  </v-col>
            ...
            <v-expansion-panels focusable accordion multiple>
              <v-expansion-panel>
                <v-expansion-panel-header>Servicios destacados</v-expansion-panel-header>
                <v-expansion-panel-content style="margin-left: -13px">
                  <v-col cols="8" md="6">
                    <v-card outlined>
                      <v-row class="pa-6">
                        ...
                        <v-autocomplete :items="spaItems" v-model="ddwnSpa" dense filled></v-autocomplete>
                      </v-row>
                    </v-card>
                  </v-col>
                  <v-col cols="8" md="6">
                  ...
                  <v-col cols="8" md="6">
                    <v-card outlined>
                      <v-row class="pa-6">
                        ...
                        <v-switch v-model="swNoSmokeRooms" inset></v-switch>
                      </v-row>
                    </v-card>
                  </v-col>
                  <v-col cols="8" md="6">
                    <v-card outlined>
                      <v-row class="pa-6">
                        ...
                        <v-switch v-model="swAirTransferService" inset></v-switch>
                      </v-row>
                    </v-card>
                  </v-col>
                  <v-col cols="8" md="6">
                    <v-card outlined>
                      <v-row class="pa-6">
                        ...
                        <v-switch v-model="swAirCollectService" inset></v-switch>
                      </v-row>
                    </v-card>
                  </v-col>
                  <v-col cols="8" md="6">
                    <v-card outlined>
                      <v-row class="pa-6">
                        ...
                        <v-switch v-model="swRecection_24h" inset></v-switch>
                      </v-row>
                    </v-card>
                  </v-col>
                  <v-col cols="8" md="6">
                    <v-card outlined>
                      <v-row class="pa-6">
                        ...
                        <v-switch v-model="swGym" inset></v-switch>
                      </v-row>
                    </v-card>
                  </v-col>
                  <v-col cols="8" md="6">
                    <v-card outlined>
                      <v-row class="pa-6">
                        ...
                        <v-switch v-model="swRoomService" inset></v-switch>
                      </v-row>
                    </v-card>
                  </v-col>
                  <v-col cols="8" md="6">
                    <v-card outlined>
                      <v-row class="pa-6">
                        ...
                        <v-switch v-model="swTerrace" inset></v-switch>
                      </v-row>
                    </v-card>
                  </v-col>
                  <v-col cols="8" md="6">
                    <v-card outlined>
                      <v-row class="pa-6">
                        ...
                        <v-switch v-model="swBar" inset></v-switch>
                      </v-row>
                    </v-card>
                  </v-col>
                  <v-col cols="8" md="6">
                    <v-card outlined>
                      <v-row class="pa-6">
                        ...
                        <v-switch v-model="swGarden" inset></v-switch>
                      </v-row>
                    </v-card>
                  </v-col>
                  <v-col cols="8" md="6">
                    <v-card outlined>
                      <v-row class="pa-6">
                        ...
                        <v-autocomplete :items="acuaticItems" v-model="ddwnAcuatic" dense filled></v-autocomplete>
                      </v-row>
                    </v-card>
                  </v-col>
                </v-expansion-panel-content>
                  ...
                  <v-col cols="8" md="6">
                    <v-card outlined>
                      <v-row class="pa-6">
                        ...
                        <v-autocomplete :items="beachItems" v-model="ddwnBeach" dense filled></v-autocomplete>
                      </v-row>
                    </v-card>
                  </v-col>
                  <v-col cols="8" md="6">
                    <v-card outlined>
                      <v-row class="pa-6">
                        ...
                        <v-switch v-model="swRecreationalActivities" inset></v-switch>
                      </v-row>
                    </v-card>
                  </v-col>
                  <v-col cols="8" md="6">
            ...
            <v-expansion-panels focusable accordion multiple>
              <v-expansion-panel>
                <v-expansion-panel-header>Transporte</v-expansion-panel-header>
                <v-expansion-panel-content style="margin-left: -13px">
                  <v-col cols="8" md="6">
                    <v-card outlined>
                      <v-row class="pa-6">
                        ...
                        <v-switch v-model="swGuardedParking" inset></v-switch>
                      </v-row>
                    </v-card>
                  </v-col>
                  <v-col cols="8" md="6">
                    <v-card outlined>
                      <v-row class="pa-6">
                        ...
                        <v-switch v-model="swStreetParking" inset></v-switch>
                      </v-row>
                    </v-card>
                  </v-col>
                  <v-col cols="8" md="6">
                    <v-card outlined>
                      <v-row class="pa-6">
                        ...
                        <v-switch v-model="swGarageParking" inset></v-switch>
                      </v-row>
                    </v-card>
                  </v-col>
                  <v-col cols="8" md="6">
                    <v-card outlined>
                      <v-row class="pa-6">
                        ...
                        <v-switch v-model="swSpecialParking" inset></v-switch>
                      </v-row>
                    </v-card>
                  </v-col>
                </v-expansion-panel-content>
            ...
            <v-expansion-panels focusable accordion multiple>
              <v-expansion-panel>
                <v-expansion-panel-header>Servicios de recepcion</v-expansion-panel-header>
                <v-expansion-panel-content style="margin-left: -13px">
                  <v-col cols="8" md="6">
                    <v-card outlined>
                      <v-row class="pa-6">
                        ...
                        <v-switch v-model="swReg_inout_private" inset></v-switch>
                      </v-row>
                    </v-card>
                  </v-col>
                  <v-col cols="8" md="6">
                    <v-card outlined>
                      <v-row class="pa-6">
                        ...
                        <v-switch v-model="swReg_inout_express" inset></v-switch>
                      </v-row>
                    </v-card>
                  </v-col>
                  <v-col cols="8" md="6">
                    <v-card outlined>
                      <v-row class="pa-6">
                        ...
                        <v-switch v-model="swTouristicInfo" inset></v-switch>
                      </v-row>
                    </v-card>
                  </v-col>
                  <v-col cols="8" md="6">
                    <v-card outlined>
                      <v-row class="pa-6">
                        ...
                        <v-switch v-model="swParkingService" inset></v-switch>
                      </v-row>
                    </v-card>
                  </v-col>
                  <v-col cols="8" md="6">
                    <v-card outlined>
                      <v-row class="pa-6">
                        ...
                        <v-switch v-model="swCurrencyChange" inset></v-switch>
                      </v-row>
                    </v-card>
                  </v-col>
                </v-expansion-panel-content>
            ...
            <v-expansion-panels focusable accordion multiple>
              <v-expansion-panel>
                <v-expansion-panel-header>Zonas comunes</v-expansion-panel-header>
                <v-expansion-panel-content style="margin-left: -13px">
                  <v-col cols="8" md="6">
                    <v-card outlined>
                      <v-row class="pa-6">
                        ...
                        <v-switch v-model="swOutdoorFurniture" inset></v-switch>
                      </v-row>
                    </v-card>
                  </v-col>
                  <v-col cols="8" md="6">
                    <v-card outlined>
                      <v-row class="pa-6">
                        ...
                        <v-switch v-model="swTerraceSolarium" inset></v-switch>
                      </v-row>
                    </v-card>
                  </v-col>
                  <v-col cols="8" md="6">
                    <v-card outlined>
                      <v-row class="pa-6">
                        ...
                        <v-switch v-model="swSharedDinner" inset></v-switch>
                      </v-row>
                    </v-card>
                  </v-col>
                  <v-col cols="8" md="6">
                    <v-card outlined>
                      <v-row class="pa-6">
                        ...
                        <v-switch v-model="swSharedSalon" inset></v-switch>
                      </v-row>
                    </v-card>
                  </v-col>
                  <v-col cols="8" md="6">
                    <v-card outlined>
                      <v-row class="pa-6">
                        ...
                        <v-switch v-model="swGameZone" inset></v-switch>
                      </v-row>
                    </v-card>
                  </v-col>
                  <v-col cols="8" md="6">
                    <v-card outlined>
                      <v-row class="pa-6">
                        ...
                        <v-switch v-model="swLibrary" inset></v-switch>
                      </v-row>
                    </v-card>
                  </v-col>
                </v-expansion-panel-content>
            ...
            <v-expansion-panels focusable accordion multiple>
              <v-expansion-panel>
                <v-expansion-panel-header>Servicios de limpieza</v-expansion-panel-header>
                <v-expansion-panel-content style="margin-left: -13px">
                  <v-col cols="8" md="6">
                    <v-card outlined>
                      <v-row class="pa-6">
                        ...
                        <v-autocomplete :items="dailyHItems" v-model="ddwnDailyH" dense filled></v-autocomplete>
                      </v-row>
                    </v-card>
                  </v-col>
                  <v-col cols="8" md="6">
                    <v-card outlined>
                      <v-row class="pa-6">
                        ...
                        <v-switch v-model="swLaundryService" inset></v-switch>
                      </v-row>
                    </v-card>
                  </v-col>
                  <v-col cols="8" md="6">
                    <v-card outlined>
                      <v-row class="pa-6">
                        ...
                        <v-switch v-model="swIronService" inset></v-switch>
                      </v-row>
                    </v-card>
                  </v-col>
                </v-expansion-panel-content>
            ...
            <v-expansion-panels focusable accordion multiple>
              <v-expansion-panel>
                <v-expansion-panel-header>Instalaciones de negocios</v-expansion-panel-header>
                <v-expansion-panel-content style="margin-left: -13px">
                  <v-col cols="8" md="6">
                    <v-card outlined>
                      <v-row class="pa-6">
                        ...
                        <v-switch v-model="swMeetingRoom" inset></v-switch>
                      </v-row>
                    </v-card>
                  </v-col>
                  <v-col cols="8" md="6">
                    <v-card outlined>
                      <v-row class="pa-6">
                        ...
                        <v-switch v-model="swMeetingCenter" inset></v-switch>
                      </v-row>
                    </v-card>
                  </v-col>
                  <v-col cols="8" md="6">
                    <v-card outlined>
                      <v-row class="pa-6">
                        ...
                        <v-switch v-model="swFaxPhotocopier" inset></v-switch>
                      </v-row>
                    </v-card>
                  </v-col>
                </v-expansion-panel-content>
            ...
            <v-expansion-panels focusable accordion multiple>
              <v-expansion-panel>
                <v-expansion-panel-header>Varios</v-expansion-panel-header>
                <v-expansion-panel-content style="margin-left: -13px">
                  <v-col cols="8" md="6">
                    <v-card outlined>
                      <v-row class="pa-6">
                        ...
                        <v-switch v-model="swCoffeeBreak" inset></v-switch>
                      </v-row>
                    </v-card>
                  </v-col>
                  <v-col cols="8" md="6">
                    <v-card outlined>
                      <v-row class="pa-6">
                        ...
                        <v-switch v-model="swSouvenirsStore" inset></v-switch>
                      </v-row>
                    </v-card>
                  </v-col>
                  <v-col cols="8" md="6">
                    <v-card outlined>
                      <v-row class="pa-6">
                        ...
                        <v-switch v-model="swInclusiveService" inset></v-switch>
                      </v-row>
                    </v-card>
                  </v-col>
                  <v-col cols="8" md="6">
                    <v-card outlined>
                      <v-row class="pa-6">
                        ...
                        <v-switch v-model="swElevator" inset></v-switch>
                      </v-row>
                    </v-card>
                  </v-col>
                  <v-col cols="8" md="6">
                    <v-card outlined>
                      <v-row class="pa-6">
                        ...
                        <v-switch v-model="swSmokingZone" inset></v-switch>
                      </v-row>
                    </v-card>
                  </v-col>
                  <v-col cols="8" md="6">
                    <v-card outlined>
                      <v-row class="pa-6">
                        ...
                        <v-switch v-model="swNoSmoking" inset></v-switch>
                      </v-row>
                    </v-card>
                  </v-col>
                  <v-col cols="8" md="6">
                    <v-card outlined>
                      <v-row class="pa-6">
                        ...
                        <v-switch v-model="swPetFriendly" inset></v-switch>
                      </v-row>
                    </v-card>
                  </v-col>
                  <v-col cols="8" md="6">
                    <v-card outlined>
                      <v-row class="pa-6">
                        ...
                        <v-switch v-model="swPetHouse" inset></v-switch>
                      </v-row>
                    </v-card>
                  </v-col>
                  <v-col cols="8" md="6">
                    <v-card outlined>
                      <v-row class="pa-6">
                        ...
                        <v-switch v-model="swPetBasket" inset></v-switch>
                      </v-row>
                    </v-card>
                  </v-col>
                  <v-col cols="8" md="6">
                    <v-card outlined>
                      <v-row class="pa-6">
                        ...
                        <v-switch v-model="swOnlyAdults" inset></v-switch>
                      </v-row>
                    </v-card>
                  </v-col>
                  <v-col cols="8" md="6">
                    <v-card outlined>
                      <v-row class="pa-6">
                        ...
                        <v-switch v-model="swSanitizedRooms" inset></v-switch>
                      </v-row>
                    </v-card>
                  </v-col>
                  <v-col cols="8" md="6">
                    <v-card outlined>
                      <v-row class="pa-6">
                        ...
                        <v-switch v-model="swBridalSuite" inset></v-switch>
                      </v-row>
                    </v-card>
                  </v-col>
                  <v-col cols="8" md="6">
                    <v-card outlined>
                      <v-row class="pa-6">
                        ...
                        <v-switch v-model="swVipService" inset></v-switch>
                      </v-row>
                    </v-card>
                  </v-col>
                  <v-col cols="8" md="6">
                    <v-card outlined>
                      <v-row class="pa-6">
                        ...
                        <v-switch v-model="swCalefaction" inset></v-switch>
                      </v-row>
                    </v-card>
                  </v-col>
                </v-expansion-panel-content>
