...
class CurrenciesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('currencies')->insert([
            ...
            ['name' => 'Rubles', 'code' => 'RUB', 'symbol' => 'руб'],
            ['name' => 'Pounds', 'code' => 'SHP', 'symbol' => '£'],
            ['name' => 'Riyals', 'code' => 'SAR', 'symbol' => '﷼'],
            ['name' => 'Dinars', 'code' => 'RSD', 'symbol' => 'Дин.'],
            ['name' => 'Rupees', 'code' => 'SCR', 'symbol' => '₨'],
            ['name' => 'Dollars', 'code' => 'SGD', 'symbol' => '$'],
            ['name' => 'Dollars', 'code' => 'SBD', 'symbol' => '$'],
            ['name' => 'Shillings', 'code' => 'SOS', 'symbol' => 'S'],
            ['name' => 'Rand', 'code' => 'ZAR', 'symbol' => 'R'],
            ['name' => 'Rupees', 'code' => 'LKR', 'symbol' => '₨'],
            ['name' => 'Kronor', 'code' => 'SEK', 'symbol' => 'kr'],
            ['name' => 'Dollars', 'code' => 'SRD', 'symbol' => '$'],
            ['name' => 'Pounds', 'code' => 'SYP', 'symbol' => '£'],
            ['name' => 'New Dollars', 'code' => 'TWD', 'symbol' => 'NT$'],
            ['name' => 'Baht', 'code' => 'THB', 'symbol' => '฿'],
            ['name' => 'Dollars', 'code' => 'TTD', 'symbol' => 'TT$'],
            ['name' => 'Lira', 'code' => 'TRY', 'symbol' => '₺'],
            ['name' => 'Liras', 'code' => 'TRL', 'symbol' => '£'],
            ['name' => 'Dollars', 'code' => 'TVD', 'symbol' => '$'],
            ['name' => 'Hryvnia', 'code' => 'UAH', 'symbol' => '₴'],
            ['name' => 'Pesos', 'code' => 'UYU', 'symbol' => '$U'],
            ['name' => 'Sums', 'code' => 'UZS', 'symbol' => 'лв'],
            ['name' => 'Bolivares Fuertes', 'code' => 'VEF', 'symbol' => 'Bs'],
            ['name' => 'Dong', 'code' => 'VND', 'symbol' => '₫'],
            ['name' => 'Rials', 'code' => 'YER', 'symbol' => '﷼'],
            ['name' => 'Zimbabwe Dollars', 'code' => 'ZWD', 'symbol' => 'Z$'],
